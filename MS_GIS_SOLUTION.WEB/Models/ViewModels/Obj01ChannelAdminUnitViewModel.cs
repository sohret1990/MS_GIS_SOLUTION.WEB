...
{
    public class Obj01ChannelAdminUnitViewModel
    {
        public Obj01ChannelAdminUnitViewModel()
        {
            ButtonPanel = new ButtonPanelViewModel { Add = true, Update = true, Delete = true, View = true, ShowMap = true, ReadOnly = false };
        }

        [Required(ErrorMessage = "Obyekt seçilməyib")]
        public int? Objectid { get; set; }
        public int? IdChannelAdminUnit { get; set; }
        public int? FkIdChannel { get; set; }
        ...
        public List<DObjectAdminUnitBarrierType> DObjectAdminUnitBarrierType { get; set; }
