...
{
    public class Obj09WinterWaterSupplyViewModel
    {
        public Obj09WinterWaterSupplyViewModel()
        {
        ...
        public int? IdWinterWaterSupplySystems { get; set; }
        ...
        public decimal? ClosedIrrigationNetworks { get; set; }
